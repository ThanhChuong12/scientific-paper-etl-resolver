...
\vspace{-2mm}\subsection{LLMs in Political Science}\vspace{-1mm} Recent research has examined the use of large language models in debates, election forecasting \cite{taubenfeld2024systematic,jiang2024donald}, and legislative behavior \cite{baker2024simulating}. However, these models have also been found to exhibit inherent biases \cite{feng2023pretraining}, and some argue that political neutrality is unattainable \cite{fisher2025political}.
...
% For further details, please see Appx.~\ref{appx:related}.
