...
To address this task we introduce a \textbf{L}anguage-\textbf{A}gnostic \textbf{M}ultilingual \textbf{A}SR pipeline through orthography \textbf{U}nification and language-specific \textbf{T}ransliteration (\shortname).
